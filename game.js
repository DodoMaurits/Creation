...
//------------ THRESHOLD 9: DINOSAURIËRS UITGESTORVEN 66 Ma --------------//
  ...
  },
  {
    ...
    hint: `Sommige caryophyllales voelen zich thuis in de duinen.`,
    tijd: 30_000_000,
    output: [
      { naam: "Anjers", icoon: "icons/Anjers.png", map: "Bloemen", 
        quote: `The fairest flowers o’ the season are the carnations
    ...
    uitleg: {
      threshold: {
        ...
        ["Kwik", "Alcohol", "Verdriet", "Trots", "Jaloezie", "Empathie", "Gemeenschap",
         ...
         "Kool", "Rabarber", "Bieten", "Spinazie", "Tomaten", "Aardappelen", "Zoete aardappelen", "Paprika", "Aubergines", 
         ...
         "Saki", "Neusapen", "Langoeren", "Gibbons", "Gorilla", "Chimpansees", "Orang-oetans", "Bonobo"
        ]
      },
      normal: {
